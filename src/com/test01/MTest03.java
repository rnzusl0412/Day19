...
public class MTest03 {
	...
	public static void Prn(Vector<score> v) {
	...
	public static void Prn01(Vector<score> v) {
	...
	public static void Prn02(Vector<score> v) {
	...
	public static void Prn03(Vector<score> v) {
		System.out.println("Case 4 : index ");

	}

	public static void main(String[] args) {
		Vector<score> vm = new Vector<score>();
		...
		System.out.println("====> 추가" + vm.elementAt(1));
		Prn(vm);
	}
}
